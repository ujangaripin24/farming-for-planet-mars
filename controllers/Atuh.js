                                                                    ...
                                                                    <td class="pad">
                                                                        <div style="font-family: sans-serif">
                                                                            <div class style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                                                                <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><em><strong>PERINGATAN LOGIN PADA AKUN ANDA</strong></em></p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            ...
                                                            <table class="text_block block-3" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                                <tr>
                                                                    <td class="pad">
                                                                        <div style="font-family: sans-serif">
                                                                            <div class style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                                                                <p style="margin: 0; text-align: center; mso-line-height-alt: 14.399999999999999px;">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Officiis eligendi, nulla quidem alias maxime ea saepe quae suscipit dolores, quaerat voluptates ducimus dolorum nobis, fugiat dolorem itaque qui esse exercitationem nihil porro amet fuga necessitatibus unde ab? Sunt assumenda numquam, officia repudiandae fuga tenetur doloremque deserunt delectus, tempora voluptate corporis.</p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
